...
const productSeeds: ProductSeed[] = [
  // Amazon Web Services
  { id: "prod-aws-free-trial", slug: "aws-account-free-trial", title: "AWS Account — Free Trial", provider_id: "prov-aws", category_id: "cat-accounts", price: 10, featured: true },
  { id: "prod-aws-8vcpu", slug: "aws-account-8-vcpu", title: "AWS Account — 8 vCPU", provider_id: "prov-aws", category_id: "cat-accounts", price: 15 },
  { id: "prod-aws-32vcpu", slug: "aws-account-32-vcpu", title: "AWS Account — 32 vCPU", provider_id: "prov-aws", category_id: "cat-accounts", price: 30 },
  { id: "prod-aws-64vcpu", slug: "aws-account-64-vcpu", title: "AWS Account — 64 vCPU", provider_id: "prov-aws", category_id: "cat-accounts", price: 50 },
  { id: "prod-aws-128vcpu", slug: "aws-account-128-vcpu", title: "AWS Account — 128 vCPU", provider_id: "prov-aws", category_id: "cat-accounts", price: 90 },
  { id: "prod-aws-256vcpu", slug: "aws-account-256-vcpu", title: "AWS Account — 256 vCPU", provider_id: "prov-aws", category_id: "cat-accounts", price: 160 },
  { id: "prod-aws-512vcpu", slug: "aws-account-512-vcpu", title: "AWS Account — 512 vCPU", provider_id: "prov-aws", category_id: "cat-accounts", price: 350 },
  { id: "prod-aws-1k-credit", slug: "aws-account-1k-credit", title: "AWS Account — $1K Credit", provider_id: "prov-aws", category_id: "cat-credits", price: 180 },
  { id: "prod-aws-5k-credit", slug: "aws-account-5k-credit", title: "AWS Account — $5K Credit", provider_id: "prov-aws", category_id: "cat-credits", price: 750 },
  ...
  { id: "prod-aws-25k-credit", slug: "aws-account-25k-credit", title: "AWS Account — $25K Credit", provider_id: "prov-aws", category_id: "cat-credits", price: 4500 },
  { id: "prod-aws-100k-credit", slug: "aws-account-100k-credit", title: "AWS Account — $100K Credit", provider_id: "prov-aws", category_id: "cat-credits", price: 9500 },
