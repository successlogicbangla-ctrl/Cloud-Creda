...
('vultr', 'Vultr', 'Buy Vultr Cloud Account', null, '/logos/vultr.svg', 'Global cloud compute infrastructure', 'Global cloud compute infrastructure with predictable, transparent pricing.', 'https://vultr.com', 6, 'Buy Vultr Cloud Account', 'Vultr cloud compute accounts and credit packages, delivered fast.'),
