...
/**
 * Homepage-only product card. Same layout/data as the shared ProductCard,
 * but the primary action is a premium "Order Now" button that goes
 * straight into the existing Telegram buy flow (BuyNowButton) instead of
 * only linking to the product page — the title/image area still links to
 * the product detail page for anyone who wants more information first.
 */
